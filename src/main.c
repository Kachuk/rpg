...
#include "engine/movement_handler.h"
...
static const u32 MAX_ENTITY_DURATION = 10000;
...
static Weapon_Type weapon_type = WEAPON_TYPE_KATANA;
...
void reset(void) {
    ...
    // Init level.
	{
		...
		physics_static_body_create((vec2){render_width *0.01, 16}, (vec2){render_width *1.5, 48}, COLLISION_LAYER_TERRAIN);
